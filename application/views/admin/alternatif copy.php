      ...
      <form class="form-horizontal" action="<?= base_url('Alternatif/add'); ?>" method="POST">
        <div class="modal-body">
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <!-- <input type="text" name="kode_alternatif" class="form-control" id="inputEmail3" value="<?= $kode_alternatif; ?>" required> -->
              <input type="text" name="kode_alternatif" class="form-control" placeholder="Masukkan kode Alternatif" id="inputEmail3" required>
            </div>
          </div>
          <div class="form-group row">
